"""
Baseline DPR training (without HANS)
Run this first to get baseline results.
"""
import os
import sys
...
# Specifying the path to the training data (using mMARCO)
...
# Configuring the model arguments - BASELINE (no HANS)
...
model_args.output_dir = "trained_models/baseline_dpr"
...
# IMPORTANT: HANS is OFF for baseline
...
if __name__ == "__main__":
    print("=" * 50)
    print("TRAINING BASELINE DPR (HANS OFF)")
    print("=" * 50)
