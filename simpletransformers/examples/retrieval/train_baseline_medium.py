"""
Baseline DPR training on medium-sized dataset (for 3-hour training window)
"""
import os
import sys
...
model_args.output_dir = "trained_models/baseline_dpr_medium"
...
if __name__ == "__main__":
    print("=" * 50)
    print("TRAINING BASELINE DPR (MEDIUM DATASET)")
    print("=" * 50)
    print(f"Training examples: {len(train_data)}")
    print(f"Validation examples: {len(eval_data)}")
