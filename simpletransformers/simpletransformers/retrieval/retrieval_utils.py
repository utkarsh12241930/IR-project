...
import transformers
import numpy as np
from simpletransformers.retrieval.hardness import (
    HardnessFeatureExtractor,
    normalize_hardness_array,
)
...
HARDNESS_EXTRACTOR = HardnessFeatureExtractor()
...
def load_hf_dataset(
    ...
    column_names.append("hardness_score")
...
def preprocess_batch_for_hf_dataset(
    ...
    hardness_scores = normalize_hardness_array(
        HARDNESS_EXTRACTOR(dataset["query_text"])
    )
    ...
    if args.hard_negatives and (args.hard_negatives_in_eval or not evaluate):
        ...
        "hardness_score": hardness_scores,
                **{
...
class RetrievalOutput:
    def __init__(
        ...
        self.hardness_loss = hardness_loss
