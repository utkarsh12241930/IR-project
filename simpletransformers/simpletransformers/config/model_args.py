...
class RetrievalArgs(Seq2SeqArgs):
    ...
    use_hans: bool = False
    hans_min_negatives: int = 1
    hans_max_negatives: int = 1
    hans_contrastive_weight_min: float = 0.6
    hans_contrastive_weight_max: float = 1.4
    hans_margin_min: float = 0.05
    hans_margin_max: float = 0.4
    hans_temperature_min: float = 0.8
    hans_temperature_max: float = 1.4
    hans_hardness_loss_weight: float = 0.1
    hans_neg_dropout_value: float = 100.0
